...
namespace VisLab.Classes
{
    public class ExperimentsTree
    {
        ...
        public class ExperimentsTreeNode : IDeserializationCallback
        {
            ...
            private static ExperimentsTreeNode root;
            ...
            {
                this.id = id;
                if (ExperimentsTreeNode.root == null) ExperimentsTreeNode.root = this;
            }
            ...
            public void Load()
            {
                ExperimentsTreeNode.root.UnloadAllDown();
                LoadAllUp();
            }

            private void LoadAllUp()
            {
                this.IsLoaded = true;
                if (ParentNode != null) ParentNode.LoadAllUp();
            }

            private void UnloadAllDown()
            {
            ...
            {
                if (ExperimentsTreeNode.root == null && this.Level == 0) ExperimentsTreeNode.root = this;
            }
        }
