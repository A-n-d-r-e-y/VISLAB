...
namespace VisLab.Forms
{
    public partial class CreateProjectForm : Form
    {
        ...
        public CreateProjectForm()
        {
            ...
            {
                string modelName = vissim.Instance.Wrap().InputFileName;
                if (modelName != ".inp")
                {
        ...
        {
            if (((!tbxModelFile.Text.Contains("<") && !tbxModelFile.Text.Contains(">") && !string.IsNullOrEmpty(tbxModelFile.Text)) ||
                (!tbxNewModelName.Text.Contains("<") && !tbxNewModelName.Text.Contains(">") && !string.IsNullOrEmpty(tbxNewModelName.Text)) ||
                rbSelectCurrent.Checked) &&
                !tbxProjectLocation.Text.Contains("<") && !tbxProjectLocation.Text.Contains(">") && !string.IsNullOrEmpty(tbxProjectLocation.Text) &&
                !tbxProjectName.Text.Contains("<") && !tbxProjectName.Text.Contains(">") && !string.IsNullOrEmpty(tbxProjectName.Text)) btnOk.Enabled = true;
